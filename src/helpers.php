...
if (! function_exists('link_to_route')) {
     ...
     * @return string
     */
    function link_to_route($name, $title = null, $parameters = [], $attributes = [], $secure = null, $escape = true)
    {
        return app('html')->linkRoute($name, $title, $parameters, $attributes, $secure, $escape);
    }
}
